...
const formatOptions: { label: string; value: SubscriptionClientFormat }[] = [{ label: "Clash YAML", value: "clash" }, { label: "Surge 配置", value: "surge" }, { label: "sing-box JSON", value: "sing-box" }, { label: "Xray JSON", value: "xray" }, { label: "URI 列表", value: "uri-list" }, { label: "Base64 URI", value: "base64" }];
