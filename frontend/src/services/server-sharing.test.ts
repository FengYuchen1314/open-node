...
const imported: FederatedServer = {
  ...
  info: {
    ...
    probe_sys: { cpu_pct: 5.5, loadavg: "0.1 0.2 0.3", mem_used: 10, mem_total: 20, disk_used: 30, disk_total: 40,
      uptime: 50, cpu_model: "CPU", cpu_cores: 2, cpu_threads: 4, os: "Debian", kernel: "6.1", arch: "amd64",
      upload_speed: 1, download_speed: 2, cumulative_up: 3, cumulative_down: 4,
      has_cpu: true, has_mem: true, has_disk: true, has_network: true, at: 5 },
    last_heartbeat: now, allow_manage_xray: false, license_required: false,
  },
  last_synced_at: now,
  created_at: now,
  license_required: false,
