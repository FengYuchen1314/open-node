...
Clash and Stash use the [global templates](subscription-templates.md) selected
by the assigned plan or system default. These files affect only rendered subscriptions.
...
| Snell v4 plain/HTTP | Yes | Excluded | Yes | Excluded |
| Snell v5 TLS obfuscation | Yes | Excluded | Yes | Excluded |
| Snell v6 default/unshaped | Excluded | Excluded | Yes | Excluded |
| Mieru TCP/UDP underlay | TCP and UDP targets | Excluded | Excluded | Excluded |
