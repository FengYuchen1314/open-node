...
baseline. The current [Agent 0.3.0a2 alpha](https://github.com/FengYuchen1314/open-node/releases/tag/agent-v0.3.0a2)
is published from exact `72b38c0`, with a verified wheel, bootstrap archive,
